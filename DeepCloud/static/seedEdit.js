...
function loadFeatureSliders(modelClass){
    ...
    for (var i = 0 ; i < colNum ; i ++) {
        ...
        x.appendChild(knob);
        knob.addEventListener('input', sendData);
        }
...
function sendLatentVector(msg) 
    {       
        ...
        xhttp.open("GET", "/latent2PC/"+sendParameters,true);
        xhttp.send();
    }
